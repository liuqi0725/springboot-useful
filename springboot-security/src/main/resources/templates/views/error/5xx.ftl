...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link rel="stylesheet" href="/assets/vendor/error-page/bootstrap.min.css">

    <link rel="stylesheet" href="/assets/vendor/error-page/style.css">


<body>

<main>
    <div class="container" style="width: 140%;margin-left: -120px;">
        <div class="row">
            <div class="col-md-6 align-self-center">
                ...
                c6.755-0.61,20.546-0.608,41.785,5.087s33.181,12.591,38.725,16.498c2.387,1.682,3.461,4.668,2.705,7.488L380.857,346.164z"></path>
                        ...
                        <g id="planet" transform="matrix(0.9997,-0.0258,0.0258,0.9997,-2.6367,14.6859)" style="transform-origin: 0px 0px;">
                            <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-miterlimit="10" cx="572.859" cy="108.803" r="90.788"></circle>

                            <circle id="craterBig" fill="none" stroke="#0E0620" stroke-width="3" stroke-miterlimit="10" cx="548.891" cy="62.319" r="13.074" style="transform-origin: 0px 0px;" transform="matrix(1,0,0,1,2.222,0)"></circle>

                            <circle id="craterSmall" fill="none" stroke="#0E0620" stroke-width="3" stroke-miterlimit="10" cx="591.743" cy="158.918" r="7.989" style="transform-origin: 0px 0px;" transform="matrix(1,0,0,1,-2.222,0)"></circle>
			...
			M483.985,127.43c23.462,1.531,52.515,2.436,83.972,2.436c36.069,0,68.978-1.19,93.922-3.149"></path>
                        ...
                        <g id="stars">
                            <g id="starsBig">
                                <g transform="matrix(1,-0.006,0.006,1,-1.5359,3.1084)" style="transform-origin: 0px 0px;">
                                ...
                                <g transform="matrix(0.967,-0.2548,0.2548,0.967,-56.5601,47.365)" style="transform-origin: 0px 0px;">
                                ...
                                <g transform="matrix(0.9989,0.0458,-0.0458,0.9989,6.9175,-14.5045)" style="transform-origin: 0px 0px;">
                                ...
                                <g transform="matrix(0.9448,0.3278,-0.3278,0.9448,172.9161,-38.5268)" style="transform-origin: 0px 0px;">
                            ...
                            <g id="starsSmall">
                                ...
                                <g style="transform-origin: 0px 0px;" transform="matrix(0.993,0,0,0.9936,1.6203,1.8892)">
                                ...
                                <g style="transform-origin: 0px 0px;" transform="matrix(0.921,0,0,0.9216,19.2785,43.2547)">
                                ...
                                <g style="transform-origin: 0px 0px;" transform="matrix(0.769,0,0,0.7696,43.0488,94.7282)">
                                ...
                                <g style="transform-origin: 0px 0px;" transform="matrix(0.537,0,0,0.5376,222.3773,190.1141)">
                            ...
                            <g id="circlesBig">
                                ...
                                <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="588.977" cy="255.978" r="7.952" transform="matrix(1,0,0,1,0,-1.481)" style="transform-origin: 0px 0px;"></circle>

                                <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="450.066" cy="320.259" r="7.952" transform="matrix(1,0,0,1,0,-1.481)" style="transform-origin: 0px 0px;"></circle>

                                <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="168.303" cy="353.753" r="7.952" transform="matrix(1,0,0,1,0,-1.481)" style="transform-origin: 0px 0px;"></circle>

                                <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="429.522" cy="201.185" r="7.952" transform="matrix(1,0,0,1,0,-1.481)" style="transform-origin: 0px 0px;"></circle>

                                <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="200.67" cy="176.313" r="7.952" transform="matrix(1,0,0,1,0,-1.481)" style="transform-origin: 0px 0px;"></circle>

                                <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="133.343" cy="477.014" r="7.952" transform="matrix(1,0,0,1,0,-1.481)" style="transform-origin: 0px 0px;"></circle>

                                <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="283.521" cy="568.033" r="7.952" transform="matrix(1,0,0,1,0,-1.481)" style="transform-origin: 0px 0px;"></circle>

                                <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="413.618" cy="482.387" r="7.952" transform="matrix(1,0,0,1,0,-1.481)" style="transform-origin: 0px 0px;"></circle>
                            </g>
                            <g id="circlesSmall">
                                <circle fill="#0E0620" cx="549.879" cy="296.402" r="2.651" transform="matrix(1,0,0,1,0,-2.963)" style="transform-origin: 0px 0px;"></circle>
                                <circle fill="#0E0620" cx="253.29" cy="229.24" r="2.651" transform="matrix(1,0,0,1,0,-2.963)" style="transform-origin: 0px 0px;"></circle>
                                <circle fill="#0E0620" cx="434.824" cy="263.931" r="2.651" transform="matrix(1,0,0,1,0,-2.963)" style="transform-origin: 0px 0px;"></circle>
                                <circle fill="#0E0620" cx="183.708" cy="544.176" r="2.651" transform="matrix(1,0,0,1,0,-2.963)" style="transform-origin: 0px 0px;"></circle>
                                <circle fill="#0E0620" cx="382.515" cy="530.923" r="2.651" transform="matrix(1,0,0,1,0,-2.963)" style="transform-origin: 0px 0px;"></circle>
                                <circle fill="#0E0620" cx="130.693" cy="305.608" r="2.651" transform="matrix(1,0,0,1,0,-2.963)" style="transform-origin: 0px 0px;"></circle>
                                <circle fill="#0E0620" cx="480.296" cy="477.014" r="2.651" transform="matrix(1,0,0,1,0,-2.963)" style="transform-origin: 0px 0px;"></circle>
                            </g>
                        </g>
                        <g id="spaceman" clip-path="url(cordClip)" transform="matrix(0.9999,0.0129,-0.0129,0.9999,2.8455,1.0668)" style="transform-origin: 0px 0px;">
			...
			C360.647,451.083,349.251,457.661,338.164,454.689z"></path>
				...
				M330.868,261.338c-7.929,1.72-15.381,5.246-21.799,10.246" style="transform-origin: 0px 0px;" transform="matrix(0.9999,0.0129,-0.0129,0.9999,3.4022,-3.5909)"></path>
            ...
            <div class="col-md-6 align-self-center">
                <h1>${errorMap.errorCode}</h1>
                <h3>${errorMap.error}</h3>
                <p><b>Error Time :</b> ${(errorMap.timestamp)?time}</p>
                <p><b>Error URL :</b> ${(errorMap.path)!""}</p>
                <p><b>Error Message :</b> ${(errorMap.errorMsg)!""}</p>
                <p><b>Request Data :</b> ${(errorMap.errorData)!""}</p>
                <p><b>Trace :</b> ${(errorMap.trace)!""}</p>
                <button onclick="history.back(-1)" class="btn green">返回首页</button>
            </div>
        </div>
    </div>
</main>

<script type="text/javascript" src="/assets/vendor/error-page/gsap.min.js"></script>
<script type="text/javascript" src="/assets/vendor/error-page/script.js"></script>
