...
import com.liuqi.springbootsecurityredisnginx.core.PjaxInterceptor;
import com.liuqi.springbootsecurityredisnginx.core.anno.FreeMarkerStatic;
import com.liuqi.springbootsecurityredisnginx.core.freemarker.FreeMarkerSpringConfig;
import com.liuqi.springbootsecurityredisnginx.utils.ClassUtil;
...
public class AppCustomerRun implements WebMvcConfigurer, ApplicationRunner {
    ...
    private Map<String,String> findFreemarkerStaticSource(){
        ...
        try {
            List<Class<?>> classes = ClassUtil.getInstance().getClasses("com.liuqi.springbootsecurityredisnginx", FreeMarkerStatic.class);
            ...
            log.error("查找带有 FreeMarkerStatic 注解的类 错误! ",e);
        }
