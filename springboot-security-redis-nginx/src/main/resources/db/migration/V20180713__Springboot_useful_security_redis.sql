...
VALUES
	(1, '0', 'admin', '超级管理员', '$2a$10$AE0nZCJCcG8mTrC3IOASz.KhqOeeB6ypOhbyaZrk4uj14P6XFVohS', '13987654321', 'liuqi_0725@aliyun.com', 1, 0, NOW()),
...
VALUES
	...
	(3, '当前用户信息', 'M_USER_INFO', 0, '003', '/user/my', '', 1),
	...
	(8, '当前权限信息', 'M_AUTH_PERMISSION', 5, '00501', '/auth/perm-list', '', 1),
	(9, '当前菜单信息',  'M_MENU_INFO', 5, '00502', '/auth/menu-list', '', 1),
	(10, '当前角色信息',  'M_ROLE_INFO', 5, '00503', '/auth/role-info', '', 1);